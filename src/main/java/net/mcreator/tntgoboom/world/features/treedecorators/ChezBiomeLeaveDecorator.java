...
public class ChezBiomeLeaveDecorator extends LeaveVineDecorator {

	public static final ChezBiomeLeaveDecorator INSTANCE = new ChezBiomeLeaveDecorator();
	...
	static {
		...
		tdt.setRegistryName("chez_biome_tree_leave_decorator");
